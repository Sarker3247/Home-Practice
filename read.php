<?php
	...
	echo "<table border> \n";
	echo "<th>DATE_OF_TRAVEL</th> <th>REASON_OF_TRAVEL</th> <th>STATUS</th>  <th>APPROVE</th><th>/REJECT</th><th>DELETE</th>\n";
	...
	while( $rows = mysqli_fetch_array( $results ) ) {
		...
		echo "<td> <a href = 'status_approve.php?traveler_id=$traveler_id&DATE_OF_TRAVEL=$DATE_OF_TRAVEL&REASON_OF_TRAVEL=$REASON_OF_TRAVEL&STATUS=$STATUS'>   Approve</a></td>";
		echo "<td> <a href = 'status_reject.php?traveler_id=$traveler_id&DATE_OF_TRAVEL=$DATE_OF_TRAVEL&REASON_OF_TRAVEL=$REASON_OF_TRAVEL&STATUS=$STATUS'>   Reject</a></td>";
